...
the manifold picture predicts. Code, checkpoints, SLURM scripts, and a no-GPU
figure regeneration path: \url{\repourl}.

\vspace{3pt}
{\footnotesize\textsf{\textbf{References}}\; [1] D.~Wurgaft, C.~Rager,
M.~Kowal, et~al. Manifold steering reveals the shared geometry of neural
network representation and behavior. \emph{arXiv:2605.05115}, 2026.\; [2]
